  ...
  <div class="auto-container">
    ...
    <div class="vsf-title-wrap">
      <div class="vsf-badge">
        ...
        <span>{{ $setting->title }} ƒ?› About Us</span>
      </div>
      ...
      <p class="vsf-sub">
        ...
        families, and vulnerable sections of society ƒ?" through education, healthcare, 
    ...
    <div class="vsf-about-grid">
      ...
      <div class="vsf-about-main">
        <h4>Who We Are</h4>
        <h2>{{ $setting->title }} ƒ?" A confluence of hope, education and empowerment.</h2>
        ...
        <p>
          ...
          Our mission is to ensure that every child can reach their fullest potential in life
           ƒ?" physically, mentally, and academically.
        </p>
        ...
        <p>
         ...
         ƒ?" all they need is the right opportunity and the right guidance.
        </p>

        <p>
          <b>{{ $setting->title }}</b> is committed to this pledge: ƒ?" 
          <em>ƒ?~Where there is need, there is our service; where there is darkness, there is the light of our efforts.ƒ?T</em>
        </p>

        <div class="vsf-pill-row">
          <span class="vsf-pill">Education &amp; Skill Development</span>
          <span class="vsf-pill">Health ƒ?› Nutrition ƒ?› Shelter</span>
      ...
      <div class="vsf-about-photo-card">
        <img src="{{ !empty($dmessage->breadcrumb) ? asset('backend/uploads/'.$dmessage->breadcrumb) : asset('frontend/custom/breadcrump.png') }}" alt="Vihatmaa Sewa Foundation Leader">
        ...
        <div class="vsf-photo-overlay">
          ...
          <span style="font-size:.78rem;opacity:.9;">
           ƒ?oService is our true calling, and empowerment is our ultimate goal.ƒ??
          </span>
        </div>
      </div>
      ...
      <div class="vsf-right-stack">
        <div class="vsf-mission-box">
          ...
          <div class="vsf-mission-text">
           ...
           them to become self-reliant ƒ?" so that they not only improve their own lives, but also become active partners 
           in building a brighter future for society.
          </div>

          <div class="vsf-mission-author">
            <h4>{{ $setting->meta_author }}</h4>
            <h6>Manager ƒ?› {{ $setting->title }}</h6>
          </div>
        </div>
        ...
        <div class="vsf-statements">
          ...
          <p>
            {{ $setting->title }} We work on six core principles ƒ?" 
            these are the identity of our work and the driving force behind our commitment to social service.ƒ??
          </p>
          <ul>
