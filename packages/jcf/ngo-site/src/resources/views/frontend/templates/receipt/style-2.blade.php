...
@font-face{font-family:"Lato Black";src:url("{{asset('frontend/custom/fonts/LatoBlack.woff2')}}") format("woff2");font-weight:900;font-style:normal;font-display:swap}</style><style>
  ...
  <div id="footer-line" class="item item--text item--footer-line" data-type="text" data-name="footer-line" data-merge="Donation are exempted u/s 80G of the I.T.Act, 1961, Vide The D.I.T (Exemption ) Regd No. AADTM Memo No: 123" data-z="33" data-source-id="footer-line" data-locked="0" data-group="" data-mask="none" data-laravel="false" data-case="original" data-font-family="Roca One Lt" data-font-weight="600" data-font-style="normal" data-font-path="{{asset('frontend/custom/fonts/RocaOneLt.woff2')}}" style="left:70px;top:490.83px;width:750px;height:13px;transform:rotate(0deg);z-index:33;clip-path:inset(0px);font-family:&quot;Roca One Lt&quot;;font-size:10px;font-weight:600;font-style:normal;color:rgb(34, 34, 34);text-align:left;line-height:16px;letter-spacing:0px;background:transparent;padding:0px 0px 0px 0px;white-space:pre-wrap;word-break:break-word;overflow-wrap:normal;overflow:visible;"><span style="color: rgba(0,0,0,var(--O42jJQ,1)); font-weight: 400">Donation receipt qualifies for deduction under Section 80G of Income Tax Act 1961. This receipt may be used for claiming income tax exemption.</span></div>
  <!-- END: Layer 20: footer-line (text) -->
  <!-- BEGIN: Layer 21: cname (text) -->
  <div id="cname" class="item item--text item--cname" data-type="text" data-name="cname" data-merge="MIRA EDUCATIONA AND WELFARE TRUST:" data-z="34" data-source-id="cname" data-locked="0" data-group="" data-mask="none" data-laravel="true" data-laravel-value="{{ $setting->title }}" data-case="original" data-font-family="Roca One Bold" data-font-weight="700" data-font-style="normal" data-font-path="{{asset('frontend/custom/fonts/RocaOneBold.woff2')}}" style="left:220px;top:48.60px;width:700px;height:41px;transform:rotate(0deg);z-index:34;clip-path:inset(0px);font-family:&quot;Roca One Bold&quot;;font-size:36px;font-weight:700;font-style:normal;color:rgb(248, 7, 7);text-align:left;line-height:48.2px;letter-spacing:0px;background:transparent;padding:0px 0px 0px 0px;white-space:pre-wrap;word-break:break-word;overflow-wrap:normal;overflow:visible;">{{ $setting->title }}</div>
  ...
  <div id="paragah" class="item item--text item--paragah" data-type="text" data-name="paragah" data-merge="name" data-z="36" data-source-id="paragah" data-locked="0" data-group="" data-mask="none" data-laravel="false" data-case="original" data-font-family="Roca One Lt" data-font-weight="400" data-font-style="normal" data-font-path="{{asset('frontend/custom/fonts/RocaOneLt.woff2')}}" style="left:59.13px;top:271.38px;width:700px;height:90px;transform:rotate(0deg);z-index:36;clip-path:inset(0px);font-family:&quot;Roca One Lt&quot;;font-size:18px;font-weight:400;font-style:normal;color:rgb(34, 34, 34);text-align:left;line-height:30px;letter-spacing:0px;background:transparent;padding:0px 0px 0px 0px;white-space:pre-wrap;word-break:break-word;overflow-wrap:normal;overflow:visible;">Received with thanks from @if($payrec->gender == 'Female')Mrs./Ms.@elseif($payrec->gender == 'Male')Mr.@endif <b>{{$payrec->name}}</b> Address {{$payrec->address}} {{$payrec->city}} Pan <b>{{$payrec->id_no}}</b>  On Date <b>{{$payrec->created_at?->format('d-m-Y')}}</b> For Donation.</div>
  <!-- END: Layer 23: paragah (text) -->
  <!--By Cash/Cheque No./D.D.No./Online-->
  ...
  <div id="payment" class="item item--text item--payment" data-type="text" data-name="payment" data-merge="9999999999" data-z="38" data-source-id="payment" data-locked="0" data-group="" data-mask="none" data-laravel="false" data-case="original" data-font-family="Lato Black" data-font-weight="600" data-font-style="normal" data-font-path="{{asset('frontend/custom/fonts/LatoBlack.woff2')}}" style="left:130.06px;top:427.84px;width:160px;height:31px;transform:rotate(0deg);z-index:38;clip-path:inset(0px);font-family:&quot;Lato Black&quot;;font-size:26px;font-weight:600;font-style:normal;color:rgb(248, 7, 7);text-align:left;line-height:31.2px;letter-spacing:0px;background:transparent;padding:0px 0px 0px 0px;white-space:pre-wrap;word-break:break-word;overflow-wrap:normal;overflow:visible;">{{
       (isset($payrec) && is_numeric($payrec->amount ?? null))
          ? number_format($payrec->amount, 0)
          : ((isset($payment) && is_numeric($payment->amount ?? null))
              ? number_format($payment->amount, 0)
              : (is_numeric(optional(optional($payrec??null)->latestPayment ?? null)->amount ?? null)
                  ? number_format(optional(optional($payrec??null)->latestPayment ?? null)->amount, 0)
                  : (is_numeric(optional(optional($user??null)->latestPayment ?? null)->amount ?? null)
                      ? number_format(optional(optional($user??null)->latestPayment ?? null)->amount, 0)
                      : '-')
                )
        )
    }}</div>
  ...
  <div id="stamp" class="item item--image item--stamp item--mask-none" data-type="image" data-name="stamp" data-z="39" data-source-id="stamp" data-locked="0" data-group="" data-mask="none" data-laravel="true" data-laravel-value="{{asset('backend/uploads/'.$setting->company_stamp)}}" style="left:480px;top:400.18px;width:113px;height:88px;transform:rotate(0deg);z-index:39;"><img src="{{asset('backend/uploads/'.$setting->company_stamp)}}" alt="" style="width:100%;height:100%;object-fit:contain;display:block;"></div>
