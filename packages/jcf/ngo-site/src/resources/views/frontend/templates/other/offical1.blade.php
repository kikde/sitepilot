...
<body>
    ...
    <div id="wb_Text4"
        ...
        <span style="color:#00008B;font-family:Arial;font-size:43px;"><strong>To,<br>The District Collector 
                    <br>{{$jletter->city}}<br>{{$jletter->state}} -{{$jletter->pincode}}<br><br>Respected Sir,<br><br>We hereby inform you honor to Mrs/Mr. {{$jletter->name}} appointed as a member of {{$jletter->landmark}}, District-{{$jletter->city}}, {{$jletter->state}}, in our organization.<br></strong></span></div>
    ...
    <div id="wb_Text7" style="position:absolute;left:131px;top:2337px;width:899px;height:161px;z-index:6;">
        <span style="color:#000000;font-family:Arial;font-size:35px;"><strong><em>Copy To<br>CC- The Public Relation
                Officer {{$jletter->city}}<br>CC- The SP District {{$jletter->city}}</em></strong></span></div>
    <div id="wb_Text8"
