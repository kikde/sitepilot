...
@php
  ...
  $list = $all_events instanceof \Illuminate\Pagination\AbstractPaginator
    ? ($all_events->getCollection() ?? collect())
    : ($all_events ?? collect());
...
<div class="content-wrapper">
  ...
  <div class="content-body">
    ...
    {{-- Pagination (only if paginator provided) --}}
    @php($isPaginated = $all_events instanceof \Illuminate\Pagination\AbstractPaginator)
    @if($isPaginated)
