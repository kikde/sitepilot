                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form form-horizontal" action="{{ url('/successstory') }}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="title" class="form-control" name="title" onchange="fillslug(this.value)" value=""placeholder="" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-12"> 
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="dob-column" class="form-control"  name="meta_tags" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="=father-floating">Excerpt</label>
                                                <textarea id="father-floating" class="form-control" name="excerpt"  ></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12"> 
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-12"> 
                                            <div class="form-group">
                                                <label for="dob-column">OgMeta Title</label>
                                                <input type="text" id="dob-column" class="form-control"  name="og_meta_title" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="father-floating" class="form-control" name="meta_description"  ></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="father-floating" class="form-control" name="og_meta_description"  ></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('success_story_category_id', $cname, null, ['class'=>"form-control",'placeholder' => 'Select One...', 'reqired']) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('status', Config::get('constants.pagestatus'), null, ['class'=>"form-control",'placeholder' => 'Select One...', 'reqired']) !!}
                                            </div>
                                        </div>
