                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Form -->
                            <form  class="mt-2" action="{{url('/page-update/'.$sectorlist->id)}}" method="post" enctype="multipart/form-data" >
                                @csrf
                                @method('PUT')
                                <input id="id" type="text" class="form-control" name="id" value="{{$sectorlist->id}}" hidden>
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-2">
                                            <label for="blog-edit-title">Name</label>
                                            <input type="text" id="blog-edit-title" class="form-control" name="name" placeholder="" value="{{$sectorlist->name}}"onchange="fillslug(this.value)" />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-2">
                                            <label for="blog-edit-slug">Slug</label>
                                            <input type="text" id="slug" class="form-control" name="slug" value="{{$sectorlist->slug}}"  />
                                        </div>
                                    </div>
                                     <div class="col-md-6 col-12">
                                        <div class="form-group mb-2">
                                            <label for="blog-edit-fund">Raised Fund(Amount)</label>
                                            <input type="number" id="raised_fund" class="form-control" name="raised_fund" value="{{$sectorlist->raised_fund}}"  min="0" step="1" />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-2">
                                            <label for="blog-edit-slug">Page Title</label>
                                            <input type="text" id="blog-edit-slug" class="form-control" name="pagetitle" value="{{$sectorlist->pagetitle}}" placeholder="" />
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-2">
                                            <label for="blog-edit-slug">Page Keyword</label>
                                            <input type="text" id="blog-edit-slug" class="form-control" name="pagekeyword" value="{{$sectorlist->pagekeyword}}" placeholder="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-2">
                                            <label for="blog-edit-slug">Page Type</label>
                                            <!-- <input type="text" id="blog-edit-slug" class="form-control" name="types" value="{{$sectorlist->types}}" placeholder="" /> -->
                                              {!! Form::select('types', Config::get('constants.types'), $sectorlist->types, ['class'=>"form-control",'placeholder' => 'Select One...', 'reqired']) !!}
                                        </div>
                                    </div>
                                        <div class="col-12">
                                        <div class="form-group mb-2">
                                                  ...
                                                  <div class="col-12">
                                                          <div class="border rounded p-2">
                                                            ...
                                                            <div class="media flex-column flex-md-row breadcrumb-media">
                                                              @if($sectorlist->breadcrumb)
                                                              <img src="{{asset('backend/uploads/'.$sectorlist->breadcrumb)}}" 
                                                      ...
                                                      <div class="col-12 mb-2">
                                                            ...
                                                            <div class="media flex-column flex-md-row signature-media">
                                                                @if($sectorlist->image)
                                                              <img src="{{asset('backend/uploads/'.$sectorlist->image)}}" 
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mb-2">
                                            ...
                                            {!! Form::select('pagestatus', Config::get('constants.pagestatus'), $sectorlist->pagestatus, ['class'=>"form-control",'placeholder' => 'Select One...', 'reqired']) !!}
                                        </div>
                                    </div>
