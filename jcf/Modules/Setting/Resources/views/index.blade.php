            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-2 mb-md-0">
                    <ul class="nav nav-pills flex-column nav-left">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="account-pill-map" data-toggle="pill"
                                href="#account-vertical-map" aria-expanded="false">
                                <i data-feather="map-pin" class="font-medium-3 mr-1"></i>
                                <span class="font-weight-bold">Location Map</span>
                            </a>
                        </li>
                        <!-- analytics -->
                        {{-- <li class="nav-item">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <!-- Location Map tab -->
                                <div class="tab-pane fade" id="account-vertical-map" role="tabpanel"
                                     aria-labelledby="account-pill-map" aria-expanded="false">
                                    <div class="row">
                                        <div class="col-12 mt-2">
                                            <form method="post" action="{{ url('settings/') }}">
                                                ...
                                                <div class="form-group">
                                                    <label for="map_iframe">Google Maps Embed (iframe)</label>
                                                    <textarea id="map_iframe" name="map_iframe" class="form-control" rows="6" placeholder="Paste your Google Maps iframe embed here">{{ old('map_iframe', $settings->map_iframe ?? '') }}</textarea>
                                                    <small class="text-muted d-block mt-25">Paste the full iframe code from Google Maps → Share → Embed a map. This will be used on the Contact page.</small>
                                                </div>
