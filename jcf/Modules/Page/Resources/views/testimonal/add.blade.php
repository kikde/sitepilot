...
@section('content')
<style>
/* ===== Fancy, mobile-friendly image picker (Team Member photo) ===== */
.tm-uploader{
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Team Member</h2>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form" action="{{ url('/testimonials') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group row align-items-start">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="tm-uploader">
                                                    <label for="account-upload" class="pick placeholder" id="tmPick" role="button" aria-label="Choose team member image">
                                                        <div class="overlay"><span><i data-feather="image"></i> Choose</span></div>
                                                    </label>
                                                    <input type="file" id="account-upload" class="d-none" name="images" accept="image/*"  required/>
                                                    <div class="actions">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9"><input type="text" id="name" class="form-control" name="name" value="" placeholder="" required/></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9"><input type="text" id="desg" class="form-control" name="desg" value="" placeholder="" /></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9"><input type="text" id="rating" class="form-control" name="rating" value="" placeholder="" /></div>
                                        </div>
                                    </div>
...
(function(){
  ...
  // set default placeholder background (circle)
  ...
  // hydrate feather icons if available
