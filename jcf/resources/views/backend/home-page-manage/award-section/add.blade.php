                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form" action="{{ url('/home/add-award') }}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <a href="javascript:void(0);" class="mr-25">
                                                        <img src="{{asset('frontend/custom/breadcrump.png')}}" id="account-upload-img" class="rounded mr-50" alt="profile image" height="150" width="150" />
                                                    </a>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" id="title" class="form-control" name="description"  value="" placeholder="" />
                                                        </div>
                                                    </div>
                                                </div>
