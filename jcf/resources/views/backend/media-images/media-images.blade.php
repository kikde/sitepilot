                                ...
                                <ul class="media-uploader-image-list media-page">
                                    @foreach($all_media_images as $image)
                                        <li
                                            ...
                                            data-imgid="{{$image->id}}"
                                            data-imgsrc="{{asset('backend/media-uploader/'.$image->path)}}"
                                            data-size="{{$image->size}}"
                                            data-dimension="{{$image->dimensions}}"
                                            data-title="{{$image->title}}"
                                            data-alt="{{$image->alt}}"
                                        >
                                        {{-- <img src="{{asset('backend/media-uploader/'.$image->path)}}" height="80" width="80" alt=""> --}}
                                    ...
                                    <div class="media-uploader-image-info" id="media-uploader-image-info">
                                        ...
                                        <div class="img-info">
                                            ...
                                            <form method="post" action="{{route('admin.upload.media.file.delete')}}" class="delete_image_form display-none">
                                                ...
                                                <button type="submit" class=" btn btn-lg btn-danger btn-sm mb-3 mr-1"><i data-feather="trash" class="mr-50"></i></button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
